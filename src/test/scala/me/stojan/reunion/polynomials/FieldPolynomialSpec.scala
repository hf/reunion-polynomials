...
class FieldPolynomialSpec extends ReunionPolynomialsSpec {
  "FieldPolynomial" should "add [+ PF(11, 1)x^1, 0.] + [+ PF(11, 1)x^1, 0.]" in {
    ...
    val b = FieldPolynomial(1, PrimeField(11, 1))

    (a + b) should be (FieldPolynomial(1, PrimeField(11, 2)))
  }
  ...
  it should "multiply [+ PF(11, 1)x^1, 0.] * [+ PF(11, 1)x^0, 0.]" in {
    val a = FieldPolynomial(1, PrimeField(11, 1))
    val b = FieldPolynomial(0, PrimeField(11, 1))
  ...
  it should "say that [+ PF(11, 1)x^0, 0.] is 1" in {
    (FieldPolynomial.isOne(FieldPolynomial(0, PrimeField(11, 1)))) should be (true)
  }

  it should "say that [+ PF(11, 1)x^1, 0.] is not 1" in {
    (FieldPolynomial.isOne(FieldPolynomial(1, PrimeField(11, 1)))) should be (false)
  }

  it should "say that [+ PF(11, 2)x^0, 0.] is not 1" in {
    (FieldPolynomial.isOne(FieldPolynomial(1, PrimeField(11, 2)))) should be (false)
  }
  ...
  it should "say that [+ PF(11, 1)x^3, 0.] is not 0" in {
    (FieldPolynomial.isZero(FieldPolynomial(3, PrimeField(11, 1)))) should be (false)
  }
  ...
  it should "say that [+ PF(11, 1)x^3, [+ PF(11, 1)x^2, 0.]] > [+ PF(11, 1)x^3, 0.]" in {
    val a = FieldPolynomial(3, PrimeField(11, 1), FieldPolynomial(2, PrimeField(11, 1)))
    val b = FieldPolynomial(3, PrimeField(11, 1))
